...
function Banner() {
  ...
  <figure><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSolVTMLcnbRoyPeKoBtqE2eBQYdr1PMRkFjA&usqp=CAU" className="w-full" /></figure>
  ...
  <div className="">
    ...
    <div>
    <button className="btn bg-red-600 text-white border-none">Search</button>
    </div>
  </div>
  </div>
</div>
